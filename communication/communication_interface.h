...
{
public:
    std::size_t blockingCommunication(std::vector<int8_t> &bufferSnd, std::vector<int8_t> &bufferRcv,
    ...
    std::size_t variableBlockingCommunication(std::vector<int8_t> &bufferSnd, std::vector<int8_t> &bufferRcv,
                                              std::size_t sndBufferBytes, std::size_t rcvBufferBytes,
